...
namespace FoodService.Data.Nugget.Pkg.Context
{
    /// <summary>
    /// Database context for the application, derived from IdentityDbContext.
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="FoodServiceDbContext"/> class.
    /// </remarks>
    public class FoodServiceDbContext : IdentityDbContext<UserBase, ApplicationRole, int>
    {
        ...
        public FoodServiceDbContext(DbContextOptions<FoodServiceDbContext> options) : base(options)
        {
        }
        ...
        private static void ConfigureProductIngredients(ModelBuilder modelBuilder)
        {
        ...
        /// </summary>
        /// <param name="modelBuilder">The model builder.</param>
        private static void ConfigureInitialData(ModelBuilder modelBuilder)
        {
